...
?>
{latLng:[<?=$r[latitude]?>, <?=$r[longitude]?>], data:"<div class='font_map'> บ้าน <?=$r[village_name]?> หมู่ <?=$r[village_moo]?> ตำบล <?=$r[name]?><br />ค่า HI  <?=$r[Hi_value]?></div>", options:{icon:<?echo $icon;?>}}<?=$k?>
<?php
	}
}
?>
