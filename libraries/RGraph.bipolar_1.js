    ...
    */
    RGraph.Bipolar.prototype.DrawTicks = function ()
    {
        ...
        this.context.beginPath();
            for (var i = this.canvas.height - this.gutterBottom; i >= this.gutterTop; i -= (barHeight + ( this.Get('chart.margin') * 2)) ) {
                if (i < (this.canvas.height - this.gutterBottom) ) {
                    this.context.moveTo(this.gutterLeft + this.axisWidth , Math.round(i));
                    this.context.lineTo(this.gutterLeft + this.axisWidth + 3, Math.round( i));
                }
            }
        this.context.stroke();
        ...
        this.context.beginPath();
            for (var i = this.canvas.height - this.gutterBottom; i >= this.gutterTop; i -= (barHeight + ( this.Get('chart.margin') * 2)) ) {
                if (i < (this.canvas.height - this.gutterBottom) ) {
                    this.context.moveTo(this.gutterLeft + this.axisWidth + this.Get('chart.gutter.center'), Math.round( i));
                    this.context.lineTo(this.gutterLeft + this.axisWidth + this.Get('chart.gutter.center') - 3, Math.round( i));
                }
            }
        this.context.stroke();
